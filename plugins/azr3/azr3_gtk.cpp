...
int main(int argc, char** argv) {
  ...
  add_knob(fbox, lv2, 0, 0, 1, 0.5, pixmap, 308, 88);
  add_knob(fbox, lv2, 1, 0, 1, 0.5, pixmap, 352, 88);
  add_knob(fbox, lv2, 2, 0, 1, 0.5, pixmap, 396, 88);
  add_knob(fbox, lv2, 3, 0, 1, 0.5, pixmap, 484, 88);
  add_knob(fbox, lv2, 4, 0, 1, 0.5, pixmap, 528, 88);
  add_knob(fbox, lv2, 5, 0, 1, 0.5, pixmap, 572, 88);
  add_knob(fbox, lv2, 6, 0, 1, 0.5, pixmap, 616, 88);
  add_switch(fbox, lv2, 7, 16, 173, Switch::Mini);
  add_switch(fbox, lv2, 8, 279, 173, Switch::Mini);
  add_switch(fbox, lv2, 9, 542, 173, Switch::Mini);
  add_switch(fbox, lv2, 10, 39, 332, Switch::Green);
  add_knob(fbox, lv2, 11, 0, 1, 0.5, pixmap, 44, 352);
  add_knob(fbox, lv2, 12, 0, 1, 0.5, pixmap, 88, 352);
  add_knob(fbox, lv2, 13, 0, 1, 0.5, pixmap, 132, 352);
  add_knob(fbox, lv2, 14, 0, 1, 0.5, pixmap, 176, 352);
  add_switch(fbox, lv2, 15, 302, 332, Switch::Green);
  add_switch(fbox, lv2, 16, 323, 356, Switch::BigRed);
  add_knob(fbox, lv2, 17, 0, 1, 0.5, pixmap, 352, 352);
  add_knob(fbox, lv2, 18, 0, 1, 0.5, pixmap, 396, 352);
  add_knob(fbox, lv2, 19, 0, 1, 0.5, pixmap, 440, 352);
  add_knob(fbox, lv2, 20, 0, 1, 0.5, pixmap, 484, 352);
  add_knob(fbox, lv2, 21, 0, 1, 0.5, pixmap, 528, 352);
  add_knob(fbox, lv2, 22, 0, 1, 0.5, pixmap, 572, 352);
  add_switch(fbox, lv2, 24, 443, 331, Switch::Mini);
  add_switch(fbox, lv2, 26, 16, 214, Switch::Mini);
  add_switch(fbox, lv2, 27, 279, 214, Switch::Mini);
  add_switch(fbox, lv2, 28, 542, 214, Switch::Mini);
